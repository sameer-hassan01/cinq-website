          ...
          {process.steps.map((s, i) => (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-6">
                ...
                <Mark className={cn("size-8 md:size-10", i % 2 === 1 ? "text-on-accent" : "text-accent")} />
              </div>
              <div className="grid gap-8 md:grid-cols-12 md:items-end">
                <div className="md:col-span-7">
                  <h3 className="font-display text-[clamp(2rem,4.5vw,4.25rem)]">{s.title}</h3>
                  <p className={cn("t-lead mt-5 max-w-[40ch] text-pretty", i % 2 === 1 ? "text-on-accent/80" : "text-bone-2")}>
                    {s.body}
                  </p>
                </div>
                <div className="md:col-span-5">
                  <p className={cn("t-mono mb-3", i % 2 === 1 ? "text-on-accent/60" : "text-bone-3")}>You get</p>
                    ...
                    {s.gets.map((g) => (
                      <li
                        ...
                        className={cn(
                          ...
                          i % 2 === 1 ? "bg-on-accent/10" : "bg-bone/8",
                        )}
                      >
                        {g}
                      </li>
